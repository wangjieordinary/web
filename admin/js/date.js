function cnVeryCalendar()
{
	...
	this.generateCalendarTable = function()
	{
		...
		// Frame Table Header
		body += "<table align='center' cellpadding='2' cellspacing='1' width='100%' height='100%' style='border:1px " + border_frame + " solid; background:white;z-index:200'>";
		body += "	<tr>";
		...
		//关闭擦除body += "				<label onclick=\"javascript:calendar.setValue('')\" style='cursor:pointer;color:" + fore_frameCaption + "; text-decoration:none;" + font_cnChar + "'>[擦除]</label> ";
		body += "				<label onclick='javascript:calendar.fadeOut();' style='cursor:pointer;color:" + fore_frameCaption + "; text-decoration:none;" + font_cnChar + "'>[关闭]</label>";
		body += "			</div>";
		body += "		</td>";
		body += "	</tr>";
		body += "	<tr>";
		...
		body += "				<tr>";
		body += "					<td style='" + font_cnChar + "'><label onclick='javascript:calendar.loadPreviousYear()' style='cursor:pointer;text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>3</font></label>年<label onclick='javascript:calendar.loadNextYear()' style='cursor:pointer;text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>4</font></label></td>";
		body += "					<td align='center' nowrap='nowrap' style='color:" + fore_currentMonth + ";" + font_cnChar + "'><b>"+ y + "年" + m + "月</b></td>";
		body += "					<td align='right' style='" + font_cnChar + "'><label onclick='javascript:calendar.loadPreviousMonth()' style='cursor:pointer;text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>3</font></label>月<label onclick='javascript:calendar.loadNextMonth()' style='cursor:pointer;text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>4</font></label></td>";
		body += "				</tr>";
		body += "			</table>";
		body += "		</td>";
		body += "	</tr>";
...
function TypeSwitch(s)
{
	...
	document.getElementById('powerspanel').style.display = 'none';
	document.getElementById('timespanpanel').style.display = 'none';
	var s = document.getElementById(s+'panel');
	s.style.display = '';
