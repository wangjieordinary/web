...
background:#EEEEF9;
 ...
 <li class="ui-state-default" style="position: relative; top: 345px; left: 1224px"><%=orderno%></li> <li class="ui-state-default" style="position: relative; top: 141px; left: -8px"><%=address%>,<%=postcode%></li> <li class="ui-state-default" style="position: relative; top: 233px; left: 932px"><%=FormatDate(atime, "YYYY-MM-DD")%> </li> <li class="ui-state-default" style="position: relative; top: 77px; left: 130px"><%=tel%></li> <li class="ui-state-default" style="position: relative; top: -128px; left: 377px"><%=consignee%></li> <li class="ui-state-default" style="position: relative; top: -226px; left: 774px">150200</li> <li class="ui-state-default" style="position: relative; top: -181px; left: -168px"><input type='text' style="border:0;" value='<%=gprice%>'  size='5'/></li> <li class="ui-state-default" style="position: relative; top: -250px; left: -648px"><textarea style='border:0;overflow:hidden; resize:none;' rows='3'><%=ggoodname%></textarea></li> <li class="ui-state-default" style="position: relative; top: -490px; left: 1494px">0</li> <li class="ui-state-default" style="position: relative; top: -337px; left: -58px"><%=postwayname%></li> <li class="ui-state-default" style="position: relative; top: -445px; left: 1094px">1</li>
  </ul>
