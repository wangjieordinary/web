...
<div class="container"><div class="content-body"><div class="fw-container"><h2>忘记密码</h2><div class="fw-form"><div class="k-item"><div class="k-label">手机号</div><input class="k-input phone-number"><span class="en-form-error require-phone-number">请输入手机号</span><span class="en-form-error error-phone-number">请输入正确的手机号</span><span class="en-form-error error-phone-exist">此手机号还未注册</span><div class="clear"></div></div><div class="k-item"><div class="k-label">图片验证码</div><input class="img-code k-input"><img class="k-img-code code-image"><span class="en-form-error error-img-code">图片验证码不正确，请重新输入</span><div class="clear"></div></div><div class="k-item"><div class="k-label">手机验证码</div><input class="phone-code k-input"><div class="k-button btn-get-code">获取验证码</div><span class="en-form-error require-phone-code">请输入手机验证码</span><div class="clear"></div></div><div class="k-item"><div class="k-label">请输入密码</div><input type="password" class="k-input password"><span class="en-form-error require-password">请输入密码</span><span class="en-form-error error-password">密码长度在6-20个字符之间</span><div class="clear"></div></div><div class="k-item"><div class="k-label">请再次输入密码</div><input type="password" class="k-input re-password"><span class="en-form-error require-re-password">请输入确认密码</span><span class="en-form-error error-re-password">两次密码输入不一致</span><div class="clear"></div></div><div class="k-item"><div class="k-button btn-update submit">确认修改</div><span class="en-form-error error-submit">。。。</span><div class="clear"></div></div></div><div class="success"><img src="/images/help-j.jpg"><div><span>密码修改成功！</span></div></div><div class="clear"></div></div></div><div class="footer-container"><div class="footer-c"><div class="f-content">
...
if a="err" and int(c)<4 and int(c)>0 then%><script type="text/javascript">show_err_msg('手机验证错误<%=int(c)&"次"%>，验证失败！','');</script><%end if%><%end if%></body></html>