...
$url = urldecode('http://www.zgnmzymyw.com/mgoods-'.$_GET["data"]).'.html'; //二维码内容  '.$_SERVER['SERVER_NAME'].'
//QRcode::png($url);
// 纠错级别：L、M、Q、H
...
//logo图片
$logo = file_get_contents('images/nmqrlogo.png');
